...
*/
_axios.default.get("https://api.github.com/users/wolfaholic").then(function (response) {
...
function cardCreator(profileInfo) {
  ...
  var theProfileLink = "URL: ".concat(profileInfo.url);
  profileLink.innerHTML = theProfileLink.link(profileInfo.url);
  followers.textContent = "Followers: ".concat(profileInfo.followers);
  following.textContent = "Following: ".concat(profileInfo.following);
  bio.textContent = "BIO: ".concat(profileInfo.bio);
  return card;
}
...
var followersArray = ['eaczechova', 'kmilliner888', 'BFlorence28', 'marksayers46', 'flowersfaerie'];
followersArray.forEach(function (user) {
  _axios.default.get("https://api.github.com/users/".concat(user)).then(function (data) {
    var card = cardCreator(data.data);
